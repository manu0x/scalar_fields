...
class GPE_field_1d
{
    ...
    GPE_field_1d(int jj,int NN,int imex_s,int nthreads=4)
    {
	  ...
	  //  R_ft =(fftw_complex*) fftw_malloc(sizeof(fftw_complex) *(N));
	    ...
	    plan_pois_f = fftw_plan_dft_1d(N,fpGpsi_ft, fpGpsi, FFTW_BACKWARD, FFTW_ESTIMATE);
    ...
    void cal_conserve_at_point(int ind,double psi2_other,double R[2],double x[2],double dx,int is_ini=0)
    {
            
            int left,right,left_y,right_y,ci;
            double der_x[2],der_amp2,psi2,fcntr,Rcntr,loc_energy,loc_mass;
            ...
            der_x[0] = (psi[right][0]+psi[left][0]-2.0*psi[ci][0])/dx;
            der_x[1] = (psi[right][1]+psi[left][1]-2.0*psi[ci][1])/dx;
            ...
            ///////////////////////////////////  (der_x)^2   /////////////////
            der_amp2 =    der_x[0]*der_x[0] + der_x[1]*der_x[1] ;
            ///////////////////////////////////////////////////
            psi2 = psi[ci][0]*psi[ci][0] + psi[ci][1]*psi[ci][1];
