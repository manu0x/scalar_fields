...
///////////////////////////////File for data/////////////////////////////////////////////////////
	...
	FILE *fpmass = fopen("mass20.txt","w");
...
///////////////////////  Evolution ///////////////////////////////////////////////////////////////
	...
	{	
			...
			for(j=0;j<s_cntr;++j)
			{
			   for(i=0;i<N;++i)
			   {
				...
				if(j==0)
				{
					...
					im_K_psi[0][s_cntr-1][i] = K[i][0]/(2.0*m);  im_K_psi[1][s_cntr-1][i] =  K[i][1]/(2.0*m);
		...
		{	
			...
			im_K_psi[0][imex_s-1][i] = K[i][0]/(2.0*m);  im_K_psi[1][imex_s-1][i] =  K[i][1]/(2.0*m);
