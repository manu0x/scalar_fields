...
void initial_hdf5_write_mpi(int *,fdm_psi_mpi ,metric_potential_mpi ,hid_t ,double *,double [][3],double [][3],double ,double,int ,bool );

void initialise_mpi(int * ,fdm_psi_mpi &,metric_potential_mpi &,double [][3],int[] ,double ,double ,double,double,double *,double &,int &,ini_power_generator,gauss_rand_field_gen_mpi,bool);
