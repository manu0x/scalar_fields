...
void initial_hdf5_write_mpi(int *,int *,fdm_poisson_mpi ,metric_potential_poisson_mpi  ,hid_t ,double *,double [][3],double [][3],double ,double,int ,bool );
...
#include "../../source_mpi/fdm3sin2/scalar_f_initial.cpp"
