...
void initialise_mpi(int * ,int *,metric_potential_mpi &,metric_potential_mpi &,double [][3],int[] ,double ,double ,double,double,double *,double &,int &,ini_power_generator,gauss_rand_field_gen_mpi,bool,double,int);
