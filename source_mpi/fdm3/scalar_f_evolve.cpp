...
{	printf("OMP Yo\n");
	...
	double a_print;
	double potn_val[n[0]*n[1]*n[2]],fa_k[2],potn,potn_k,
					potn_a,potn_a_part,dc[n[0]*n[1]*n[2]],pwr_spec[n[0]*n[1]*n[2]],acc_fa,potn_rhs,f_a_rhs;

	double psi_b[2],psi_amp2;
	double f_lap;
	double potn_der[3],potn_retrive;
	int i,j,k,ci,ind[3];
	int c1,c2,fail=0;
	int step_cnt;
	int num_prints = 14;
