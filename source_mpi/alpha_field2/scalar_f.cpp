using namespace std;
#include "../../include_mpi/alpha_field2/include_custom.h"
...
///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//if(use_omp)
	fail = evolve_kdk_openmp(ind,n_axis_loc,f_alpha,poisson_phi,k_grid,kbin_grid,a0,ai,a0,omega_dm_ini,Xb_0,dx,dk,kbins,da,cum_lin_ind,use_hdf5_format);
	//else
