...
///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	metric_potential_poisson_mpi psi_r(n_axis,n_axis_loc,cum_lin_ind,1),psi_i(n_axis,n_axis_loc,cum_lin_ind,2);
	metric_potential_poisson_mpi V(n_axis,n_axis_loc,cum_lin_ind,0);
	...
	//if(use_omp)
	fail = evolve_kdk_openmp(ind,n_axis_loc,psi_r,psi_i,phi,k_grid,kbin_grid,a0,ai,a0,omega_dm_ini,Xb_0,dx,dk,kbins,da,cum_lin_ind,use_hdf5_format);
	//else
