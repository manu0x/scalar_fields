...
double field_acc_eqn(double f_a,double f_sx[3],double f_a_x[3],double lap_f,double phi,double phi_a,double phi_sx[3],double a,double a_t,double a_tt)
{
	double numer,denom;	
...
*/	
	...
	acc = (numer/denom) - a_tt*f_a/(a_t*a_t);
